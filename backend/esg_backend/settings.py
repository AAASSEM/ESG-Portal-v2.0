...
if not DEBUG:
    STATICFILES_STORAGE = 'whitenoise.storage.CompressedStaticFilesStorage'  # More lenient, doesn't fail on missing source maps
else:
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 100,  # Increased to handle comprehensive ESG framework (80 elements)
